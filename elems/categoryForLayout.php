...
$description = "
    <meta name=\"description\" content=\"Каталог интернет-магазина $catName. Цены, фото, описания товаров и скидки.\">
    <meta property=\"og:description\" content=\"Каталог интернет-магазина $catName. Цены, фото, описания товаров и скидки.\">
    <meta property=\"og:image\" content=\"$prefhostHTTP$hostHTTP/images/logo/$catURI.jpg\">
    <meta property=\"og:image:type\" content=\"image/jpeg\">
    <meta property=\"og:site_name\" content=\"$hostHTTP\">
    <meta property=\"og:title\" content=\"Интернет-магазин $catName: каталог с фото и ценами\">
    <meta property=\"og:type\" content=\"website\">
    <meta property=\"og:url\" content=\"$prefhostHTTP$hostHTTP/$catURI\">
";
...
foreach ($data as $tovar) {
    ...
    $content .= "<img src=\"{$tovar['picture']}\" alt=\"Картинка - {$tovar['name']}\" onload=\"goodLoadImg(this);\" onerror=\"errLoadImg(this);\">";
    $content .= '</a></div>';
